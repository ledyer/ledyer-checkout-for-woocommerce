...
class AJAX extends \WC_AJAX
{
	...
	public static function lco_wc_change_payment_method()
	{
		...
		WC()
			->payment_gateways()
			->set_current_gateway($available_gateways);
			...
			foreach ($fields as $key => $value) {
				switch ($key) {
					...
					case "shipping_first_name":
						$fields["shipping_address"][$key] = isset($ledyer_order["customer"]["shippingAddress"]["contact"])
							? $ledyer_order["customer"]["shippingAddress"]["contact"]["firstName"]
							: "";
						break;
					...
					case "shipping_last_name":
						$fields["shipping_address"][$key] = isset($ledyer_order["customer"]["shippingAddress"]["contact"])
							? $ledyer_order["customer"]["shippingAddress"]["contact"]["lastName"]
							: "";
						break;
					case "billing_company":
						$fields["billing_address"][$key] = isset($ledyer_order["customer"]["billingAddress"])
							? $ledyer_order["customer"]["billingAddress"]["companyName"]
							: "";
						break;
					case "shipping_company":
						$fields["shipping_address"][$key] = isset($ledyer_order["customer"]["shippingAddress"])
							? $ledyer_order["customer"]["shippingAddress"]["companyName"]
							: "";
						break;
					case "billing_country":
						$fields["billing_address"][$key] = isset($ledyer_order["customer"]["billingAddress"])
							? $ledyer_order["customer"]["billingAddress"]["country"]
							: "";
						break;
					case "shipping_country":
						$fields["shipping_address"][$key] = isset($ledyer_order["customer"]["shippingAddress"])
							? $ledyer_order["customer"]["shippingAddress"]["country"]
							: "";
						break;
					case "billing_address_1":
						$fields["billing_address"][$key] = isset($ledyer_order["customer"]["billingAddress"])
							? (empty($ledyer_order["customer"]["billingAddress"]["streetAddress"])
								? $ledyer_order["customer"]["billingAddress"]["companyName"]
								: $ledyer_order["customer"]["billingAddress"]["streetAddress"])
							: "";
						break;
					case "shipping_address_1":
						$fields["shipping_address"][$key] = isset($ledyer_order["customer"]["shippingAddress"])
							? (empty($ledyer_order["customer"]["shippingAddress"]["streetAddress"])
								? $ledyer_order["customer"]["shippingAddress"]["companyName"]
								: $ledyer_order["customer"]["shippingAddress"]["streetAddress"])
							: "";
						break;
					case "billing_postcode":
						$fields["billing_address"][$key] = isset($ledyer_order["customer"]["billingAddress"])
							? $ledyer_order["customer"]["billingAddress"]["postalCode"]
							: "";
						break;
					case "shipping_postcode":
						$fields["shipping_address"][$key] = isset($ledyer_order["customer"]["shippingAddress"])
							? $ledyer_order["customer"]["shippingAddress"]["postalCode"]
							: "";
						break;
					case "billing_city":
						$fields["billing_address"][$key] = isset($ledyer_order["customer"]["billingAddress"])
							? $ledyer_order["customer"]["billingAddress"]["city"]
							: "";
						break;
					case "shipping_city":
						$fields["shipping_address"][$key] = isset($ledyer_order["customer"]["shippingAddress"])
							? $ledyer_order["customer"]["shippingAddress"]["city"]
							: "";
						break;
					case "billing_phone":
					...
					case "shipping_phone":
						$fields["shipping_address"][$key] = isset($ledyer_order["customer"]["shippingAddress"]["contact"])
							? $ledyer_order["customer"]["shippingAddress"]["contact"]["phone"]
							: "";
						break;
					case "shipping_email":
						$fields["shipping_address"][$key] = isset($ledyer_order["customer"]["shippingAddress"]["contact"])
							? $ledyer_order["customer"]["shippingAddress"]["contact"]["email"]
							: "";
						break;
					default:
						unset($fields[$key]);
